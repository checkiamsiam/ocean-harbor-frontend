          ...
          <div className="flex flex-col gap-10">
            <div>
              <FAQsAndAns
                ...
                send a mail to us at info@oceanharbor.nl so our admin can register you as a customer. The sales manager of your area will contact
            ...
            <div>
              <FAQsAndAns
                ...
                answer="In case of a delivery announcement you can contact our logistics department at transport@oceanharbor.nl. If you are a supplier and you would like us to carry your products you can send your company information to purchase@oceanharbor.nl."
              />
            </div>
            <div>
              <FAQsAndAns
